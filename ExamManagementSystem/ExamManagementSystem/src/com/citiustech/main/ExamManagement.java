...
import com.citiustech.admin.AdminDao;
	...
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			case 1:
				...
				if (AdminDao.validateAdmin(username, passwd)) {
					...
					do {
						...
						case 8:
							...
							StudentDao.updateStudent(stRollNo, stFirstName, stLastName, stGender, stPassword, stAddress,
									stEmail, stCourse);
						...
						case 13:
							...
							Questions questions = new Questions(questionId, question, examId, opt1, opt2, opt3,
									correctAns);
						...
						case 14:
							...
							QuestionsDao.updateQuestion(queId, questId, questn, exmId, option1, option2, option3,
									corrtAns);
			...
			case 2:
				...
				if (StudentDao.validateStudent(email, password)) {
					...
					// Perform student operations based on the email and
					// password
					...
					do {
						...
						switch (choice) {
						case 1:
							// Call the method or perform the action for "Go For
							// Test" option
							// goForTest();
							...
							break;
						case 2:
							// Call the method or perform the action for "See
							// Your Report Card" option
							// seeReportCard();
